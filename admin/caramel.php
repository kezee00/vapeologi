...
<div class="product-container">
  <div class="product-image">
    <img src="caramel.png" alt="SMOK Nord 5">
  </div>
  ...
  <div class="product-details">
    ...
    <div class="price">
      <span class="original">Rp:111.000</span>
      <span class="discounted">Rp:111.000</span>
    </div>
    ...
    <div class="actions">
      <button class="cart"><a href="keranjang6.php" class="sekarang">Masukkan Keranjang</button>
       <button class="buy"><a href="keranjang6.php" class="sekarang">Beli Sekarang</button>
    </div>
