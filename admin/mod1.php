...
<div class="product-container">
  ...
  <div class="product-details">
    ...
    <div class="price">
      <span class="original">Rp:650.000</span>
      <span class="discounted">Rp:600.000</span>
    </div>
    ...
    <div class="actions">
      <button class="cart"><a href="keranjang1.php" class="sekarang">Masukkan Keranjang</button>
      <button class="buy"><a href="keranjang1.php" class="sekarang">Beli Sekarang</button>
    </div>
