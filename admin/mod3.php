...
<div class="product-container">
  <div class="product-image">
    <img src="produk2.png" alt="SMOK Nord 5">
  </div>
  ...
  <div class="product-details">
    ...
    <div class="price">
      <span class="original">Rp.700.000</span>
      <span class="discounted">Rp:650.000</span>
    </div>
    ...
    <div class="actions">
      <button class="cart"><a href="keranjang3.php" class="sekarang">Masukkan Keranjang</button>
      <button class="buy"><a href="keranjang3.php" class="sekarang">Beli Sekarang</button>
    </div>
